...
#ifndef priority_queue_collection_h
#define priority_queue_collection_h

#include <AD/contain/seqcol.h>

template <class T>
class PriQueueCollection : public SequenceableCollection<T>
{
public:
  //////////////////////////////////////////////////////////////
  //  Selectors
  ...
  // virtual T& operator [] (Ix) const; // inherited
};
