...
#ifndef hash_table_with_Brents_hashing2_h
#define hash_table_with_Brents_hashing2_h

////////////////////////////////////////////////////////////////////////////
// Class BHashTable2 implements a hash table using Brent's reordering
...
public:
  ...
  ////////////////////////////////////////////////////////////////////
  BHashTable2(int initial_size      = 32,
  ...
  //  Assignment
  ////////////////////////////////////////////////////////////////////
  void operator = (const BHashTable2&);
...
template <class K, class V, class C>
inline Ix BHashTable2<K,V,C>::find_next(register int i) const
{
  while (i < table_size)
...
template <class K, class V, class C>
void BHashTable2<K,V,C>::operator = (const BHashTable2<K,V,C>& t)
{
  if (this != &t)
  {
    delete [] keys;
...
template <class K, class V, class C>
Ix BHashTable2<K,V,C>::lookup(const K& key) const
{
...
template <class K, class V, class C>
Ix BHashTable2<K,V,C>::insert(const K& key, const V& value)
{
  /////////////////////////////////////////////////////////////////////
...
template <class K, class V, class C>
void BHashTable2<K,V,C>::resize(int new_size)
{
