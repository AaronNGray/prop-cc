...
////////////////////////////////////////////////////////////////////////////
// Class CHashTable implements a hash table using coaleased hashing
...
public:
  ...
  ////////////////////////////////////////////////////////////////////
  CHashTable( int initial_size      = 32,
...
//////////////////////////////////////////////////////////////////////////
template <class K, class V>
inline Ix CHashTable<K,V>::find_next(register int i) const
{
  while (i < table_size)
    if (chain[i++])
      return (Ix)i;
...
template <class K, class V>
void CHashTable<K,V>::operator = (const CHashTable<K,V>& t)
{
  if (this != &t)
  {
    delete [] keys;
...
template <class K, class V>
Ix CHashTable<K,V>::lookup(const K& key) const
{
...
template <class K, class V>
Ix CHashTable<K,V>::insert(const K& key, const V& value)
{
  /////////////////////////////////////////////////////////////////////
...
template <class K, class V>
void CHashTable<K,V>::resize(int new_size)
{
