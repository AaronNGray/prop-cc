...
#ifndef hash_table_with_double_hashing_h
#define hash_table_with_double_hashing_h

////////////////////////////////////////////////////////////////////////////
// Class DHashTable implements a hash table using a double hashing
...
////////////////////////////////////////////////////////////////////////////
//  Class |DHashTable| is parameterized with the class of the
...
public:
  ...
  ////////////////////////////////////////////////////////////////////
  DHashTable(int initial_size      = 32,
  ...
  //  Assignment
  ////////////////////////////////////////////////////////////////////
  void operator = (const DHashTable&);
...
template <class K, class V>
void DHashTable<K,V>::operator = (const DHashTable<K,V>& t)
{
  if (this != &t)
  {
    delete [] keys;
...
template <class K, class V>
Ix DHashTable<K,V>::lookup(const K& key) const
{
...
template <class K, class V>
Ix DHashTable<K,V>::insert(const K& key, const V& value)
{
  /////////////////////////////////////////////////////////////////////
...
template <class K, class V>
void DHashTable<K,V>::resize(int new_size)
{
