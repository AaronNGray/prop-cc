...
AGTerminal::AGTerminal(const char* id, AGParseTree* sibling, AGParseTree* child)
...
AGNonterminal::AGNonterminal( int production_no, AGParseTree* sibling, AGParseTree* child)
    : AGParseTree(sibling, child),
